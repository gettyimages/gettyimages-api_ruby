...
echo Running Authentication Feature
call bundle exec cucumber ..\features\authentication.feature -r .\features\step_definitions\authentication.feature.rb
...
rem echo Running Image Search Feature
rem call bundle exec cucumber ..\features\ImageSearch.feature -r .\features\step_definitions\ImageSearch.feature.rb
