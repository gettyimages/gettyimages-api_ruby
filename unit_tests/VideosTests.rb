...
class VideosTests < Test::Unit::TestCase
    ...
    def test_videos_with_ids_with_accept_language
        stub_request(:get, "https://api.gettyimages.com/v3/videos").with(headers: {"Accept-Language" => "de"}).with(query: {"ids" => ["123","333"].join(",")})
            .to_return(body: '{ "message": "success" }')
